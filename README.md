...
* 0.3.1/\*.h: Header files.
* 0.3.1/\*.c: Source files.
* 0.3.1/Doxyfile: configuration file to generate doxygen documentation.
* 0.3.1/Makefile: to build the executable program.
* 0.3.1/case\*: different example cases input files.
* 0.3.1/script.sh: a shell script to generate some convergence plots.
* 0.3.1/plot: a GNUPlot input file to do the plots.
